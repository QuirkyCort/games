...
gdjs.evtsExt__THNK__OnRSCreationRequest.conditionTrue_0 = {val:false};
gdjs.evtsExt__THNK__OnRSCreationRequest.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__THNK__OnRSCreationRequest.condition1IsTrue_0 = {val:false};
...
gdjs.evtsExt__THNK__OnRSCreationRequest.condition0IsTrue_0.val = false;
{
/* Unknown instruction - skipped. */}if (gdjs.evtsExt__THNK__OnRSCreationRequest.condition0IsTrue_0.val) {
{/* Unknown instruction - skipped. */}{gdjs.evtTools.debuggerTools.log("Remote scene '" + (typeof eventsFunctionContext !== 'undefined' ? "" + eventsFunctionContext.getArgument("remote_scene_name") : "") + "' based on scene '" + (typeof eventsFunctionContext !== 'undefined' ? "" + eventsFunctionContext.getArgument("base_scene_name") : "") + "' created", "info", "Dedicated server");
