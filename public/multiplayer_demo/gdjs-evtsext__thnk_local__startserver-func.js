...
gdjs.evtsExt__THNK_Local__StartServer.conditionTrue_0 = {val:false};
gdjs.evtsExt__THNK_Local__StartServer.condition0IsTrue_0 = {val:false};


gdjs.evtsExt__THNK_Local__StartServer.userFunc0x861ec0 = function(runtimeScene, eventsFunctionContext) {
"use strict";
...
for (
    ...
    if (remote) {
        ...
        // As a fallback, open with the natove window.open
...
gdjs.evtsExt__THNK_Local__StartServer.userFunc0x861ec0(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);
