var gdjs;
(function(gdjs2) {
  gdjs2.PixiFiltersTools.registerFilterCreator("Reflection", {
    makePIXIFilter: function(layer, effectData) {
      let time = 0;
      const reflectionFilter = new PIXI.filters.ReflectionFilter(effectData.booleanParameters.mirror, effectData.doubleParameters.boundary, [
    ...
    updatePreRender: function(filter, target) {
      if (filter.animationSpeed !== 0) {
        filter.time += target.getElapsedTime() / 1e3 * filter.animationSpeed;
      }
    },
